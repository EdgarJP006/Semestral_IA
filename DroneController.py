...
class DroneController:
    ...
    def start_main_loop(self):
        ...
        while self.loop_running:
            ...
            # Llama la funcion para analizar la imagen
            self.analyze_image()
    ...
    def handle_key_stroke(self):
        ...
        # After parturn_leftsing the input events
    ...
    def print_intel(self):
        ...
        control_text_distance = "dis= {0:f}".format(self.control["distance"])
        ...
        if self.automatic_mode:
            cv.putText(self.img, "Siguiendo codigo", (int(round(self.image_shape[1] * .4)), 30), font, 1, (0, 255, 0), 2)
